...
class BaseModel(nn.Module):
    def __init__(self, block, blocks, embed_dim=64, res_expansion=1.0, head=16, head_dim=32, activation="relu", bias=True,
                 normalize="anchor", dims=[64,128,256,512], pre_blocks=[2, 2, 2, 2], pos_blocks=[2, 2, 2, 2],
